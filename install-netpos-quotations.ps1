# ============================================================
# NETPOS HOSPITALITY - QUOTATIONS MODULE INSTALLER
#
# Run from the project root:
#   C:\Users\Administrator\netpos-hospitality
#
# Command:
#   powershell -ExecutionPolicy Bypass -File .\install-netpos-quotations.ps1
#
# Creates/replaces:
...
New-Item -ItemType Directory -Force -Path ".\app\quotations" | Out-Null
      ...
      <section style={hero}>
        <div style={brandRow}>
          ...
          <div>
            ...
            <div style={subtitle}>Billing & Accounts</div>
          </div>
        </div>

        <Link href="/reservations" style={primaryButton}>
          Open Reservations
        </Link>
      </section>
      ...
      <section style={content}>
        <div style={headingRow}>
          <div>
            ...
            <p style={muted}>
              Quotations, guest accounts, invoices, payments and daily financial activity.
            </p>
          </div>
        </div>

        <div style={grid}>
          <Link href="/quotations" style={card}>
            <div style={cardIcon}>01</div>
            <h3 style={cardTitle}>Quotations</h3>
            <p style={cardText}>
              Create professional room quotations, print or save them as PDF,
              track status and start a reservation from an accepted quote.
            </p>
            <span style={cardAction}>Open Quotations →</span>
          </Link>

          <Link href="/reservations" style={card}>
            <div style={cardIcon}>02</div>
            <h3 style={cardTitle}>Reservation Accounts</h3>
            <p style={cardText}>
              Open reservations to view invoices, record payments, check
              balances and print guest documents.
            </p>
            <span style={cardAction}>Open Reservations →</span>
          </Link>

          <Link href="/front-desk" style={card}>
            <div style={cardIcon}>03</div>
            <h3 style={cardTitle}>Outstanding Accounts</h3>
            <p style={cardText}>
              Review guests and reservations that still have money outstanding.
            </p>
            <span style={cardAction}>View Outstanding →</span>
          </Link>

          <Link href="/cash-up" style={card}>
            <div style={cardIcon}>04</div>
            <h3 style={cardTitle}>X Report / End of Day</h3>
            <p style={cardText}>
              Review Cash, Card, EFT and refunds for the current trading period.
            </p>
            <span style={cardAction}>Open X Report →</span>
          </Link>
        </div>
      </section>
    </main>
...
const hero: CSSProperties = {
  ...
  padding: "17px 20px",
  borderRadius: 14,
  background: "linear-gradient(135deg,#0C3D78,#1764B0)",
  color: "#fff",
  display: "flex",
  justifyContent: "space-between",
  alignItems: "center",
...
const card: CSSProperties = {
  ...
  color: "#17324D",
  textDecoration: "none",
  boxShadow: "0 5px 15px rgba(15,60,105,.06)",
};
...
Set-Content `
  -Path ".\app\quotations\page.tsx" `
  -Value $quotationCode `
  -Encoding UTF8

Write-Host ""
Write-Host "NETPOS QUOTATIONS MODULE INSTALLED" -ForegroundColor Green
Write-Host ""
Write-Host "Created:"
Write-Host "  app\quotations\page.tsx"
Write-Host "Updated:"
Write-Host "  app\billing\page.tsx"
Write-Host "  src\components\NetposAccessGuard.tsx"
Write-Host ""
Write-Host "Next:"
Write-Host "  1. Run the quotation SQL migration in Supabase."
Write-Host "  2. Restart Next.js with npm run dev."
Write-Host "  3. Open http://localhost:3000/quotations"
Write-Host ""
