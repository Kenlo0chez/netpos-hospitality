...
const page: CSSProperties = { minHeight:"100vh", background:"#F4F8FC", color:"#17324D", fontFamily:'Inter, "Segoe UI", Arial, sans-serif' };
...
const liveBadge: CSSProperties = { padding:"6px 9px", borderRadius:20, background:"#EDF6FF", color:"#1268B3", fontSize:7, fontWeight:900 };
...
const eodIcon: CSSProperties = { background:"#EDF6FF", color:"#1268B3" };
const cardTag: CSSProperties = { color:"#7A8998", fontSize:7, fontWeight:900, letterSpacing:.5 };
const eodTag: CSSProperties = { color:"#1268B3" };
...
const eodAction: CSSProperties = { color:"#1268B3" };
